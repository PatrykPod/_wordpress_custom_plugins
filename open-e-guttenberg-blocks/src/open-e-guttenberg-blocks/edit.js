...
export default function Edit({ attributes, setAttributes }) {
	const { content, textAlign, isBold, isItalic, isUnderline } = attributes;
	...
	return (
		<>
			...
			<BlockControls>
				<ToolbarGroup>
					<ToolbarButton
						...
						label={__('Underline', 'open-e-guttenberg-blocks')}
			...
			<RichText
				...
				placeholder={__('Enter highlighted text...', 'open-e-guttenberg-blocks')}
				style={{
					textAlign: textAlign,
